...
def parse_args():
    ...
    parser.add_argument("--save-frequency", type=int, default=10000, help="the frequency to save the models locally")
...
class FeatureExtractor(nn.Module):
    def __init__(self, obs_shape):
        ...
        self.fc = nn.Linear(out_dims, 100)
...
if __name__=="__main__":
    ...
    for global_step in range(args.max_step):
        ...
        if global_step % args.save_frequency == 0:
            torch.save(actor.state_dict(), 'Models/pixel_actor_DMC.pth')
            torch.save(Q_net.state_dict(), 'Models/pixel_Q_DMC.pth')
