...
def make_env(task_name, skip_frame, seed, maximum_episode_length, capture_video, run_name):
    def thunk():
        ...
        if capture_video and idx == 0:
            ...
            env = CausalWorld(task=task, skip_frame=skip_frame, seed=seed, max_episode_length = maximum_episode_length)
...
"""
    ...
    rb = replayBuffer(envs.single_observation_space.shape[0], envs.single_action_space.shape[0], capacity=args.buffer_size, device=device)
